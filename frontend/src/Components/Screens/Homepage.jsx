  ...
  return (
    ...
    <div className="container">
        ...
        <CodingPage
          ...
          path="https://drive.google.com/file/d/1r-Jcm2teLO8UNgyLCsfY-vY1v6h0kJpj/view?usp=sharing"
          ...
          info={<>Helping in enhancing coding efficiency and accessibility through <mark>voice-driven</mark> automation and seamless <mark>user interaction</mark>. </>}
          con="View Details"
          image={MoreCod}
          // poss={{'flexDirection':'row'}}
        />
