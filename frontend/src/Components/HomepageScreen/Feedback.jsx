        ...
        <img src={blob} alt="" className='blob_a blob3' />
            ...
            <div className='feedSection'>
                <div className='feedinfo'>
                    <p className="info">Join the<mark>Amazing</mark>community and become part of something <mark>great</mark>! Share your feedback and any website-related<mark> issues to help us improve and make your experience even better.</mark></p>
                </div>
